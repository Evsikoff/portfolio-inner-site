...
const CREDITS = [
    {
        ...
        rows: [['Andrey Evsikov', 'All']],
    },
    {
        title: 'Modeling & Texturing',
        rows: [
            ['Andrey Evsikov', 'Texturing, Composition, & UV'],
    ...
    },
    {
        title: 'Sound Design',
        rows: [
            ['Andrey Evsikov', 'Mixing, Composition, & Foley'],
...
const Credits: React.FC<CreditsProps> = (props) => {
    ...
    return (
        ...
        <Window
            ...
            bottomLeftText={'© Copyright 2022 Andrey Evsikov'}
        >
            <div
