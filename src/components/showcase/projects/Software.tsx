    ...
    return (
        <div className="site-page-content">
            ...
            <div className="text-block">
                <h2>AndreyEvsikov.com</h2>
                <br />
                <p>
                    AndreyEvsikov.com is my portfolio website, and also the
                ...
                <p>
                    ...
                    <a
                        rel="noreferrer"
                        target="_blank"
                        href="https://AndreyEvsikov.vercel.app/"
                    >
                        here
                    </a>{' '}
                ...
                <ul>
                    <li>
                        <a
                            rel="noreferrer"
                            target="_blank"
                            href="https://AndreyEvsikov.com"
                        >
                            <p>
                                <b>[3D Site]</b> - AndreyEvsikov.com
                            </p>
                        </a>
                    </li>
                    <li>
                        ...
                        >
                            <p>
                                <b>[OS Site]</b> - AndreyEvsikov.vercel.app
                            </p>
                        </a>
                    </li>
                    <li>
                        <a
                            rel="noreferrer"
                            target="_blank"
                            href="https://github.com/Andreyjeff/portfolio-website"
                        >
                            <p>
                    ...
                    <li>
                        <a
                            rel="noreferrer"
                            target="_blank"
                            href="https://github.com/Andreyjeff/portfolio-inner-site"
                        >
                            <p>
                ...
                <ul>
                    ...
                    <li>
                        <a
                            rel="noreferrer"
                            target="_blank"
                            href="https://github.com/Andreyjeff/gsts_assets"
                        >
                            <p>
                                <b>[GitHub]</b> - Guntattchment Saga The Sequel
                                Assets Repository
                ...
                <ul>
                    <li>
                        <a
                            rel="noreferrer"
                            target="_blank"
                            href="https://github.com/Andreyjeff/skip-the-scroll"
                        >
                            <p>
